...
//nanosleep to delay process successive calls to print out time
...
if(argc!=3) {
  fprintf(stderr, "Usage: %s <slee time..msec><num_iterations>\n",argv[0]);
  exit(0);
}
...
printf("Delay is %d ms..num_iter is %d\n",delay,num_iter);
...
for(i=0;i<num_iter;++i)
{
  ...
  now2=curr_time1.tv_sec + curr_time2.tv_nsec*0.000000001;
